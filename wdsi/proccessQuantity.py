...
# def variables(quantity, duration, supplies, assemble):
#     order_size = quantity
#     order_time = duration
#     supplies_stock = supplies
#     assembling_time = assemble
#     return order_size, order_time, supplies_stock, assembling_time
